                ...
                <div className="cartContenedor"> 
                    ...
                    <div className="total">
                        <div className="finalDeCompra">
                            <button className="vaciarCarrito" onClick={ clearCart  }>Vaciar carrito de compras</button>
                            <button className="seguirComprando">
                                <Link className="seguirComprandoLink" to="/">Continuar comprando</Link>
                            </button>
                            <button className="realizarCompra"> 
                                <Link className="realizarCompraLink" to="/Form">Realizar la Compra</Link>
                            </button>
